...
输入广告名称
    ...
    sleep       3s
上传图片
    # Input Text      xpath:/html/body/div[1]/div/div[2]/div[2]/div[2]/div[2]/div/div[5]/div/div[2]/form/div[7]/div/div[2]/div/input      C:\\Users\\Administrator\\Pictures\\1\\1.jpg
    Click Element     css:body > div.container > div > div.panel > div.panel-main > div.el-row > div:nth-child(2) > div > div:nth-child(5) > div > div.el-dialog__body > form > div.el-form-item.adCon.is-required > div > div.upload-demo > div > div
    # Choose File     css:body > div.container > div > div.panel > div.panel-main > div.el-row > div:nth-child(2) > div > div:nth-child(5) > div > div.el-dialog__body > form > div.el-form-item.adCon.is-required > div > div.upload-demo > div > div > div > em     C:\\Users\\Administrator\\Pictures\\1\\1.jpg
    sleep       3s
# 点击跳转业务
#     Click Element       xpath:/html/body/div[1]/div/div[2]/div[2]/div[2]/div[2]/div/div[5]/div/div[2]/form/div[8]/div/div/div/div/div[1]/input
#     sleep   3s
#     Click Element       css:body > div:nth-child(12) > div > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul > li:nth-child(4) > span
#     sleep   3s
# # 输入跳转网页
# # 输入跳转页面标题
# 广告发布日期
#     Click Element       xpath:/html/body/div[1]/div/div[2]/div[2]/div[2]/div[2]/div/div[5]/div/div[2]/form/div[10]/div/div/i
#     sleep       3s
#     Click Element        css:body > div.el-picker-panel.el-date-picker.has-time > div.el-picker-panel__footer > button
#     # Click Element       xpath:body > div.container > div > div.panel > div.panel-main > div.el-row > div:nth-child(2) > div > div:nth-child(5) > div > div.el-dialog__body > form > div:nth-child(10) > div > div > input
#     sleep       3s
#     # Input Text       xpath:/html/body/div[10]/div[1]/div/div[1]/span[1]/div/input       2018-06-06
#     # sleep       3s
#     # Input Text      xpath:/html/body/div[10]/div[1]/div/div[1]/span[2]/div[1]/input     12:24:00
#     # sleep       3s
#     # Click Element       xpath:/html/body/div[10]/div[2]/button

# 广告结束日期
#     Click Element       xpath:/html/body/div[1]/div/div[2]/div[2]/div[2]/div[2]/div/div[5]/div/div[2]/form/div[11]/div/div/i
#     sleep       3s
#     Click Element       xpath:/html/body/div[11]/div[2]/button
#     sleep       3s
# 点击申请发布  
